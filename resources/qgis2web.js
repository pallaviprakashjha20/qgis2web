...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [303167.642114, 2862525.849724, 303434.497360, 2862656.296390], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32645',
            //extent: [303268.578529, 2862526.994947, 303335.075421, 2862653.285366],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([303167.642114, 2862525.849724, 303434.497360, 2862656.296390], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_InternalLayoutZoning_3,
    colName: 'layer',
    zoom: 10,
    collapsed: true,
    map: map,
